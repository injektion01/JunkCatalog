             ...
             <div class="row">
				...
				<table id="myTable" class="table table-light table-striped table-bordered  bg-light" cellspacing="0" width="100%"> 
						...
						<tr onMouseOver="this.style.cursor='pointer'" class="header">
							...
							<th onclick="sortTable('table', 1)">Item Location↕</th>
							<th onclick="sortTable('table', 2)">Item Sub-locations↕</th>
							<th onclick="sortTable('table', 3)">Units In Stock↕</th>
							<th onclick="sortTable('table', 4)">Checked out↕</th>
							<th onclick="sortTable('table', 5)">Image↕</th>                                               
					...
					<tbody><p>
                                        ...
                                        echo  '<tr>'
                                                ...
                                                . '<td>'.trim($ItemLocation).'</td>'
                                                . '<td>'.trim($ItemSubLocation).'</td>'
                                                . '<td>'.trim($UnitsInStock).'</td>'
                                                . '<td>'.trim($CheckedOut).'</td>'
                                                . '<td><a href="data/items/'.$ItemName.'/icon.jpg" ><img src="data/items/'.$ItemName.'/icon.jpg" alt="Icon" height="75" /></a></td>'
                                                .'</tr>';              
